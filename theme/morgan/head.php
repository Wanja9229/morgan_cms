...
$_is_character_page = in_array($_current_script, array('character.php', 'character_edit.php', 'character_form.php'));
$_is_character_list_page = in_array($_current_script, array('character_list.php', 'character_view.php'));
