...
<div id="rp-write-modal" class="fixed z-50 hidden items-center justify-center p-4 md:p-6">
    <div class="absolute inset-0 bg-black/60 backdrop-blur-sm" onclick="if(document._mgMdTarget===this)closeWriteModal()"></div>
...
(function() {
    ...
    window.openImageModal = function(src) {
        ...
        if (!modal) {
            ...
            modal.innerHTML = '<div class="absolute inset-0 bg-black/80 backdrop-blur-sm" onclick="if(document._mgMdTarget===this)closeImageModal()"></div>' +
