<?php
/**
 * Morgan Edition - Prompt Mission Board View Skin
 */
...
<div id="bo_view" class="mg-inner">
    ...
    <article class="card mb-4">
        ...
        <div class="flex items-center gap-2 p-3 bg-mg-bg-primary rounded-lg mb-4 border border-mg-bg-tertiary">
            ...
            <span class="text-mg-accent font-medium"><?php echo htmlspecialchars($mg_entry['pm_title']); ?></span>
            <?php echo _prompt_view_status_badge($mg_entry['pe_status']); ?>
            <?php if ((int)$mg_entry['pe_point'] > 0) { ?>
            <span class="text-sm text-mg-text-muted">+<?php echo number_format($mg_entry['pe_point']); ?>P</span>
            <?php } elseif ((int)$mg_entry['pm_point'] > 0 && $mg_entry['pe_status'] !== 'rejected') { ?>
            <span class="text-sm text-mg-text-muted">+<?php echo number_format($mg_entry['pm_point']); ?>P</span>
            <?php } ?>
            <?php if ((int)$mg_entry['pe_is_bonus']) { ?>
            <span class="badge bg-mg-accent/20 text-mg-accent">우수작</span>
            <?php } ?>
        </div>
        <?php } ?>
