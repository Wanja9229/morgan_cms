...
> 진영별 인트라넷, 코드네임 익명 게시판, 진영 간 대립 시스템.
> 상세: docs/MODULES.md (익명망 섹션)

### C.1 익명망 기본
- [ ] 기획서 작성 (독립 MD)
- [ ] DB 설계 (mg_anon_season, mg_anon_codename, mg_anon_board)
- [ ] 시즌 관리 (분기별 코드네임 리셋)
- [ ] 진영별 게시판 분리 + 접근 제어
- [ ] 코드네임 시스템 (진영 접두어 + 번호)
