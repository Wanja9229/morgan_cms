...
if ($is_admin)
    echo run_replace('content_admin_button_html', '<div style="text-align:right;margin-bottom:0.5rem;" class="mg-inner px-4"><a href="'.G5_ADMIN_URL.'/morgan/content_page.php?co_id='.$co_id.'" class="text-sm text-mg-accent hover:text-mg-accent-hover transition-colors">내용 수정</a></div>', $co);
?>
