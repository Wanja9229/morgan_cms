    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-mg-bg-secondary rounded-xl border border-mg-bg-tertiary overflow-hidden">
            <div class="px-4 py-3 bg-mg-bg-tertiary/50 border-b border-mg-bg-tertiary flex items-center justify-between">
                ...
                <a href="<?php echo G5_BBS_URL; ?>/seal_edit.php" class="text-xs text-mg-accent hover:underline">편집</a>
            </div>
            <div class="p-4">
                <?php if ($seal) { ?>
                <div style="transform:scale(0.9);transform-origin:top left;">
                    <?php echo mg_render_seal($mb['mb_id'], 'compact'); ?>
                </div>
                ...
                <div class="text-center py-6">
                    ...
                    <a href="<?php echo G5_BBS_URL; ?>/seal_edit.php" class="text-sm text-mg-accent hover:underline">인장 만들기</a>
                </div>
                <?php } ?>
            </div>
        </div>
